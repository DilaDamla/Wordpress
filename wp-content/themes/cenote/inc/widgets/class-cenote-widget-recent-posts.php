...
class Cenote_Widget_Recent_Posts extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description'                 => esc_html__( 'Shows recent post with an image', 'cenote' ),
			...
			<?php foreach ( $r->posts as $recent_post ) : ?>
				...
				<li>
					<?php if ( has_post_thumbnail( $recent_post->ID ) ) : ?>
						<a class="tg-recent-post-thumbnail" href="<?php the_permalink( $recent_post->ID ); ?>"><?php echo get_the_post_thumbnail( $recent_post->ID, 'thumbnail' ); ?></a>
					<?php endif; ?>
