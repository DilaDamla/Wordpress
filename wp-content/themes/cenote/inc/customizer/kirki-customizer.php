...
/**
 * Cenote Hero Options section
 */
Kirki::add_section( 'cenote_section_hero', array(
	'title'    => esc_html__( 'Hero', 'cenote' ),
	'panel'    => 'cenote_theme_options',
	'priority' => 25,
) );

/**
 * Cenote Breadcrumb Options section
 */
Kirki::add_section( 'cenote_section_breadcrumb', array(
	'title'    => esc_html__( 'Breadcrumb', 'cenote' ),
	'panel'    => 'cenote_theme_options',
	'priority' => 25,
) );
...
// Cenote hero options file goes here.
